...
public class SunlightEnhancement {
    ...
    private static String FILE_SLE = "/sys/class/graphics/fb0/sle";
	...
	return FileUtils.isFileWritable(FILE_SLE);
    }
	...
	return FileUtils.readOneLine(FILE_SLE).equals("1");
    }
	...
	return FileUtils.writeLine(FILE_SLE, (status ? "1" : "0"));
    }
