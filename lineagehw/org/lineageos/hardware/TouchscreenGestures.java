...
public class TouchscreenGestures {
    ...
    private static final String[] GESTURE_PATHS = {
        "/sys/lenovo_tp_gestures/letter_v_enable",
        "/sys/lenovo_tp_gestures/letter_z_enable",
        "/sys/lenovo_tp_gestures/letter_c_enable",
        "/sys/lenovo_tp_gestures/letter_e_enable",
        "/sys/lenovo_tp_gestures/letter_s_enable",
        "/sys/lenovo_tp_gestures/letter_w_enable",
    };

    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "Letter V", 263),
        new TouchscreenGesture(1, "Letter Z", 264),
        new TouchscreenGesture(2, "Letter C", 265),
        new TouchscreenGesture(3, "Letter E", 266),
        new TouchscreenGesture(4, "Letter S", 267),
        new TouchscreenGesture(5, "Letter W", 268),
    };
